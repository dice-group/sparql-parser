...
class sparqlParserBase(ConanFile):
    ...
    requires="sparql-parser-base/0.2.2@dice-group/stable","sparql-query/0.11@dice-group/rc1","rdf-parser/0.13@dice-group/stable","robin-hood-hashing/3.9.1","gtest/1.8.1"
