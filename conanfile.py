...
class sparqlParserBase(ConanFile):
    ...
    requires="sparql-parser-base/0.1.3@dice-group/stable","sparql-query/0.9@dice-group/stable","rdf-parser/0.12@dice-group/stable","robin-hood-hashing/3.9.1","gtest/1.8.1"
